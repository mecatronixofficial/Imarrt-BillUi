...
export default function PurchaseDocumentRegister(props: Props) {
  ...
  const open = documents.filter(
    (document) => document.status === "DRAFT" || document.status === "ISSUED",
  ).length;
  ...
  return (
    <>
      <PageHeader
        ...
        action={
          <Link
            href={DOCUMENT_CONFIG[props.type].createPath}
        ...
        <div className="flex flex-col gap-3 border-b border-slate-100 p-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="relative w-full sm:w-80">
            ...
            <input
              ...
              placeholder="Search number, supplier, or reference..."
            ...
            <table className="w-full min-w-[880px] text-sm">
              <thead className="bg-slate-50/80 text-left text-[10px] uppercase tracking-wider text-slate-400">
                <tr>
                  ...
                  <th className="px-5 py-3 font-semibold">Supplier / Party</th>
